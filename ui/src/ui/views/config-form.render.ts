...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  env: {
    ...
    description: "Variáveis de ambiente passadas para o processo gateway",
  },
  update: {
    label: "Atualizações",
    description: "Configurações de atualização automática e canal de lançamento",
  },
  agents: { label: "Agentes", description: "Configurações, modelos e identidades dos agentes" },
  auth: { label: "Autenticação", description: "Chaves de API e perfis de autenticação" },
  channels: {
    label: "Canais",
    description: "Canais de mensagem (Telegram, Discord, Slack, etc.)",
  },
  messages: {
    label: "Mensagens",
    description: "Configurações de roteamento e tratamento de mensagens",
  },
  commands: { label: "Comandos", description: "Comandos de barra personalizados" },
  hooks: { label: "Ganchos", description: "Webhooks e ganchos de eventos" },
  skills: { label: "Habilidades", description: "Pacotes de habilidades e capacidades" },
  tools: {
    label: "Ferramentas",
    description: "Configurações de ferramentas (navegador, busca, etc.)",
  },
  gateway: {
    label: "Gateway",
  ...
  bindings: { label: "Atalhos", description: "Atalhos de teclado e bindings" },
  ...
  canvasHost: { label: "Host do Canvas", description: "Renderização e exibição do Canvas" },
